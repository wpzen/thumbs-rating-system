...
<div data-id="<?php echo self::get_post_id(); ?>" rel="v:rating" id="thumbs-rating-system">
	...
	<div class="rating__question">
		<?php echo Thumbs_Rating_System_Options::get_option( 'title_text' ); ?>	
	</div>
	...
	<div id="rating__vote" class="rating__vote">
		...
		<div class="rating__scale">
			...
			<button class="rating__btn rating__btn_like" data-type="like">
				...
				<?php esc_html_e( 'Yes', 'thumbs-rating-system' ); ?>
			</button><!-- .rating__btn_like -->

			<button class="rating__btn rating__btn_unlike" data-type="dislike">
				<svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false">
					<g>
						<path d="M15 3H6c-.83 0-1.54.5-1.84 1.22l-3.02 7.05c-.09.23-.14.47-.14.73v1.91l.01.01L1 14c0 1.1.9 2 2 2h6.31l-.95 4.57-.03.32c0 .41.17.79.44 1.06L9.83 23l6.59-6.59c.36-.36.58-.86.58-1.41V5c0-1.1-.9-2-2-2zm4 0v12h4V3h-4z"></path>
					</g>
      			</svg>
      			<?php esc_html_e( 'No', 'thumbs-rating-system' ); ?>
	...
	<?php if ( Thumbs_Rating_System_Options::get_option( 'enable_stats' ) ) : ?>
